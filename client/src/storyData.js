const storyData = [
  ...
  },
  {
    ...
    full_story: [
      ...
      'The door was not fastened, because the Bears were good Bears, who did nobody any harm, and never suspected that anybody would harm them. So Goldilocks opened the door and went in; and well pleased was she when she saw the porridge on the table. If she had been a well-brought-up little girl she would have waited till the Bears came home, and then, perhaps, they would have asked her to breakfast; for they were good Bears—a little rough or so, as the manner of Bears is, but for all that very good-natured and hospitable. But she was an impudent, rude little girl, and so she set about helping herself.',
  ...
  },
  {
    ...
    full_story: [
      ...
      '"Oh, no! Don\'t take me. Wait a little till the big Billy Goat Gruff comes. He\'s much bigger." "Very well! Be off with you," said the troll. But just then up came the big Billy Goat Gruff. Trip, trap, trip, trap, trip, trap! went the bridge, for the billy goat was so heavy that the bridge creaked and groaned under him.',
      '"Who\'s that tramping over my bridge?" roared the troll. "It is I! The big Billy Goat Gruff," said the billy goat, who had an ugly hoarse voice of his own. "Now I\'m coming to gobble you up," roared the troll.',
  ...
  },
  {
    ...
    description:
      "The Little Old Woman Who Lived in a Shoe was published in My First Picture Book, Printed in colours by Kronheim (1875). You might also enjoy reading Mother Goose's nursery rhyme, There was an Old Woman Who Lived in a Shoe, and L. Frank Baum's short story, The Woman Who Lived in a Shoe.",
    full_story: [
      ...
      'Night came on, and as the father did not return, the Old Lady and her family went to search for him. When they came to that part of the wood where the Giant had met their father, they saw an immense shoe. They spent a long time weeping and calling out for their father, but met with no reply. Then the Old Lady thought that they had better take shelter in the shoe until they could build a new house. So Peter and Strong-arm put a roof to it, and cut a door, and turned it into a dwelling.',
      "Here they all lived happily for many years, but the Little Old Lady never forgot her husband and his sad fate. Strong-arm, who saw how wretched his mother often was about it, proposed to the next eleven brothers that they should go with him and set their father free from the Giant. Their mother knew the Giant's strength, and would not hear of the attempt, as she feared they would be killed.",
